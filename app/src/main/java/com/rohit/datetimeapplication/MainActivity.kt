package com.rohit.datetimeapplication
...
import com.rohit.datetimeapplication.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.datePicker?.setOnClickListener {
            var Dialog = DatePickerDialog(
                ...
                setTheme(R.style.Base_Theme_DateTimeApplication)
            }.show()
        }
            ...
            val timePickerDialog = TimePickerDialog(
                ...
                { _, hourOfDay, minute ->
                    ...
                    if (hourOfDay >= 9 && hourOfDay < 18) {
                        ...
                        Toast.makeText(this, "Please select a time between 9 AM and 6 PM", Toast.LENGTH_SHORT).show()
                    }
                },
